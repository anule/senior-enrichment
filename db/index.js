...
module.exports = new Sequelize(connectionString, {
  ...
  native: true, // lets Sequelize know we can use pg-native for ~30% more speed (if you have issues
  // with pg-native feel free to take this out and work it back in later when we have time to help)
});
